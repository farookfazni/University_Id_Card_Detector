...
if height >=644 and weight>=1064:
    image=cv2.resize(image,(1029,644)) #resizing because opencv does not work well with bigger images
    orig=image.copy()
...
#the loop extracts the boundary contours of the page
    ...
    pts=np.float32([[0,0],[1029,0],[1029,644],[0,644]])  #map to 800*800 target window

    op=cv2.getPerspectiveTransform(approx,pts)  #get the top or bird eye view effect
    dst=cv2.warpPerspective(orig,op,(1029,644))
